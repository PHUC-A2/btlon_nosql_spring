...
import com.example.quanlysanphamthoitrang.service.CustomUserDetailsService;
        ...
        public SecurityFilterChain securityFilterChain(HttpSecurity http,
                ...
                http
                                .authorizeHttpRequests(auth -> auth
                                                ...
                                                .requestMatchers("/", "/user/sanpham/chitiet/*",
                                                                "/user/sanpham/timkiem", "/user/sanpham/tatca",
                                                                "/hello", "/css/**",
                                                                "/js/**", "/images/**")
                                                .permitAll()
                                ...
                                .logout(logout -> logout
                                                ...
                                                .logoutSuccessUrl("/?logout") // chuyển sang trang "/"
                                                .permitAll());
